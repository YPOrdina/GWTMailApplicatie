package nl.ordina.yp.gwtmailapp.server;
    ...
    public void downloadEmails(String protocol, String host, String port,
        ...
        try {
            ...
            for (int i = 0; i < messages.length; i++) {
                ...
                toList = parseAddresses(msg
                        .getRecipients(RecipientType.TO));
                ccList = parseAddresses(msg
...
//        String protocol = "imap";
//        String host = "www.fmf.nl";
//        String port = "993";
        
        String userName = "ordinayptest@gmail.com";
        String password = "ordinayptest2014";
